...
-- Create unique constraints for captain and vice-captain
CREATE UNIQUE INDEX idx_fantasy_team_captain 
ON public.fantasy_team_players (fantasy_team_id, gameweek_id) 
WHERE is_captain = true;

CREATE UNIQUE INDEX idx_fantasy_team_vice_captain 
ON public.fantasy_team_players (fantasy_team_id, gameweek_id) 
